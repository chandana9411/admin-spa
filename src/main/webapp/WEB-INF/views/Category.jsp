...
<form:form action="${addAction}" modelAttribute="category" id="btn-add">
   <h3>
	  ...
	  <td>category_Id:</td> <td><form:input  path="category_id"/></td> 
	    ...
	    <tr> <td> Name:</td> <td><form:input type="text"  placeholder="category" class="form-control name" path="name" value="${category.name}"/></td> 
	    <tr> <td>Description:</td> <td><form:input type="text"  placeholder="category" class="form-control name" path="description" value="${category.description}"/> </td> 
	    <tr> <td colspan="2">
    	        <c:if test="${category.category_id==0}">
